    ...
    private void loadCities() {
        ...
        for (String idStr : citiesConfig.getKeys(false)) {
            try {
                ...
                City city = new City(id, name, ownerId, center.getWorld(), minPoint, maxPoint, center);
                ...
                city.setLastTaxCollection(citiesConfig.getLong(idStr + ".lastTaxCollection", System.currentTimeMillis()));
